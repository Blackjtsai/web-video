...
| day2 | Day 2：藏王溫泉滑雪場・熟悉日（仙台→藏王） | 6 | `.d2-` |
...
- **雪場變動（2026-08-09 更新行程.md）**：**Eboshi 整個拿掉**。Day2、Day3 都在**藏王溫泉滑雪場**——Day2 熟悉（中央區、橫倉區、仙台出發約 1.5h），Day3 進階（地藏山頂、樹冰區、Long Cruise、山形出發約 30 分）。文案由「3 座雪場」改「2 大雪場 · 3 個滑雪日」（藏王 2 天 + Spring Valley 夜滑）
