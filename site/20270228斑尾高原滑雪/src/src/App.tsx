...
const SPLIT_IMAGES: Record<string, string[]> = {
  "sp-day1": [
    `${base}images/day1.jpg`, // step 0: 去程交通
    `${base}images/day1.jpg`, // step 1: 抵達開滑
  ],
  "sp-day2": [
    `${base}images/day2.jpg`, // step 0: 斑尾全山攻略
  ],
  "sp-day3": [
    `${base}images/day3.jpg`, // step 0: 斑尾 → Tangram
  ],
  "sp-day4": [
    `${base}images/day4.jpg`, // step 0: Best Snow Day
    `${base}images/day4.jpg`, // step 1: 回程交通
  ],
  // sp-coldopen / sp-must-know 不設圖片 → 顯示完整章節畫面
};
